...
0.575m/2 + 0.372m/2 = 0.4735f

*/
#define MOTOR_DISTANCE_TO_CENTER 0.4735f
...
/*
SZL 5-21-2022 重新算 NewINF
2pi/60 * 1/19 * (0.084m Hex轮子半径) = 4.629715490e-4f
For Hero
152.5mm/2 = 老轮子半径 = 76.25mm = 0.07625m
2pi/60 * 1/19 * (0.077m  老轮子半径) = 
*/
#define CHASSIS_MOTOR_RPM_TO_VECTOR_SEN M3508_MOTOR_RPM_TO_VECTOR
...
//PR 底盘线性油门
#define TURBO_SPEED 2.8f //2.4f //全油门模式速度
#define TURBO_ACC_STEP 0.029f //油门步进（加速度控制）
#define TURBO_INT_SPEED 0.2f //0.15f //初始加速值（降低加速迟滞）

#define SLOW_SPEED 1.4f //1.3f	//5-24-2022之前 1.4f //低速 模式速度
#define SLOW_ACC_STEP 0.015f //油门步进（加速度控制）
#define SLOW_INT_SPEED 0.1f //初始加速值（降低加速迟	滞）
#define SPIN_SPEED 3.8f//5-24-2022之前3.6f//6.0f //小陀螺速度 6.0f
/*
...
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 1.5f//又有点太快1.9f//5-24 9:10 am 1.2f//3.0f
...
//底盘电机速度环PID
#define M3505_MOTOR_SPEED_PID_KP 6000.0f//6000//4000//9000
#define M3505_MOTOR_SPEED_PID_KI 0.1f//10
#define M3505_MOTOR_SPEED_PID_KD 0.0f
#define M3505_MOTOR_SPEED_PID_MAX_OUT MAX_MOTOR_CAN_CURRENT
#define M3505_MOTOR_SPEED_PID_MAX_IOUT 1000.0f//2000
...
//底盘旋转跟随PID	
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 3.0f//10.0f//18.0f //5.5f//6.0f //40.0f  //Pr////5.5//2
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f//0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 10.0f
