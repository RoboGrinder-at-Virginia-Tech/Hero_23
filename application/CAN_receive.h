...
typedef enum
{
    ...
    CAN_TRIGGER_MOTOR_ID = 0x207,
		CAN_TRIGGER_MOTOR_17mm_ID = 0x208,
...
/**
  ...
  * @retval         none
  */
extern void CAN_cmd_gimbal2(int16_t shoot,int16_t yaw, int16_t shoot_17mm);

extern void CAN_cmd_gimbal_new_Hero_gimbal(int16_t pitch, int16_t yaw, int16_t shoot_42mm, int16_t shoot_17mm);
...
extern const motor_measure_t *get_trigger_motor_measure_17mm_point(void);
